...
function Header() {
  ...
  return (
    <header id="header" className="py-4 w-full absolute top-0">
      <nav className="container flex justify-between items-center">
        ...
        <ul className="hidden lg:flex items-center gap-16">
          <li
            onClick={() => {
              scroll.scrollTo(document.querySelector("#home"));
            }}
            className="text-white cursor-pointer text-xl font-semibold font-Jost capitalize hover:opacity-90"
          >
            home
          </li>
          <li
